...
$portfolio = [
    ...
    // --- CERTIFICADOS ---
    // Para agregar uno nuevo en el futuro: copia un bloque [ ] y rellena los datos
    "certificados" => [
        [
            "nombre"      => "Inteligencia Artificial Nivel Básico",
            "institucion" => "Talento Tech · MinTIC",
            "fecha"       => "Agosto 2025",
            "duracion"    => "159 horas",
            "imagen"      => "Certificado_IA_Talentotech.png",
            "icono"       => "🤖",
            "color"       => "#6C63FF",
        ],
        [
            "nombre"      => "Git y GitHub desde Cero",
            "institucion" => "mouredev.pro",
            "fecha"       => "Febrero 2026",
            "duracion"    => "Curso completo",
            "imagen"      => "Certificacion_git.png",
            "icono"       => "🔧",
            "color"       => "#FF6584",
        ],
        [
            "nombre"      => "Iniciación al Desarrollo con IA",
            "institucion" => "BIG school · mouredev",
            "fecha"       => "Febrero 2026",
            "duracion"    => "6 horas",
            "imagen"      => "Certificado_FundamentosIA.png",
            "icono"       => "💡",
            "color"       => "#43E97B",
        ],
    ],
